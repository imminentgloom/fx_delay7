...
function FxDelay7:add_params()
	...
	FxDelay7:add_control("fx_delay7_time", "time", "time", controlspec.new(0.0001, 2, "exp", 0, 0.55, "s"))
	FxDelay7:add_control("fx_delay7_feedback", "feedback", "feedback", controlspec.new(0, 1, "lin", 0.01, 0.8, ""))
	FxDelay7:add_control("fx_delay7_sep", "sep", "sep", controlspec.new(0, 0.1, "lin", 0.0001, 0, ""))
	FxDelay7:add_control("fx_delay7_mix", "mix", "mix", controlspec.new(0, 1, "lin", 0.01, 0.4, ""))
	FxDelay7:add_control("fx_delay7_send", "send", "send", controlspec.new(0, 1, "lin", 0.01, 0.8, ""))
